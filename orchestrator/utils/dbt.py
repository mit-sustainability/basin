...
SNOWFLAKE_URL = (
    f"https://app.snowflake.com/ax61354/{SNOWFLAKE_ACCOUNT_BASE}/#/data/databases/{PURINA_DATABASE_NAME}/schemas"
)
...
class CustomDagsterDbtTranslator(DagsterDbtTranslator):
    ...
    def get_asset_key(cls, dbt_resource_props: Mapping[str, Any]) -> AssetKey:
        ...
        if resource_type in ("model", "seed"):
            schema = dbt_resource_props["schema"] if dbt_resource_props["schema"] else "unknown_schema"
