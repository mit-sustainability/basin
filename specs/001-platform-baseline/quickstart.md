...
4. If selective ECS offload is enabled, verify that the EC2-hosted Dagster instance can launch the configured ECS task definition and that the task can reach the warehouse before materializing an offloaded asset.
